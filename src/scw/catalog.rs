    ...
    Product {
        ...
        resources: &[
            ...
            res!("api-keys", "/api-keys", needs = "organization_id",
                ...
                check!(Medium, "iam.api-keys.default-project", "an Object Storage preferred project that is not the one the key is otherwise scoped to"),
            ...
            res!("ssh-keys", "/ssh-keys", needs = "organization_id",
                ...
                check!(High, "iam.ssh-keys.orphan", "a key whose owner has left, still installed on every new machine"),
                check!(Medium, "iam.ssh-keys.weak", "an RSA key under 3072 bits, or a DSA key"),
